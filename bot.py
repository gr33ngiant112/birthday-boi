...
In this version, the tree sync is only performed once in setup_hook. This should help ensure that all commands (including /forecast_bdays) register correctly with Discord.# filepath: /home/xx/projects/birthday-boi/bot.py
#!/usr/local/bin/python3
import os
import redis
import ssl
